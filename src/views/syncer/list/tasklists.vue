...
<!--          v-if="row.status!='deleted'"-->
            ...
            <el-button  slot="reference" size="mini" :type="row.status | deleteTaskButtion"  :plain="row.status | deleteButtionStatus" :disabled="row.status | deleteButtionStatus" @click="handleDelete(row)">
              删除
            </el-button>
    ...
    <pagination v-show="total>0" :total="total" :page.sync="listParam.currentPage" :limit.sync="listParam.pageSize" @pagination="getList" />


    <el-dialog :title="textMap[dialogStatus]" :visible.sync="add.dialogFormVisible" width="400px">
      <!--      <el-row :gutter="20">-->
      ...
      <el-form
        ...
        label-width="120px"
      >
        <el-form-item v-show="addTask.fromRedis" prop="tasktype" label="任务类型">
          <el-select
